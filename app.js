...
function phatTiengBip() {
  ...
  try {
    ...
    audio.play().catch((err) => {
      console.warn("Không phát được âm mp3, dùng âm dự phòng:", err);
      phatAmThanhFallbackWav();
    });
  } catch (e) {
    console.warn("Lỗi phatTiengBip:", e);
    phatAmThanhFallbackWav();
  }
}
